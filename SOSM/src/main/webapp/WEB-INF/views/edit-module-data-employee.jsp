...
<head> 
    ...
    <title>Редактиране на модул</title>
...
<div id="wrapper">
    ...
    <div id="textbox">
		<form action="/app/employee/editModuleRecord" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" name="fullName" id="fullName" value="${module.fullName}" required>
				</div>
			</div>
			<div class="form-group">
		    	<div class="col-sm-offset-4 col-sm-2">
			    	<input type="hidden" name="id" value="${module.id}" required>
		...
		<br>
		<form action="/app/employee/deleteModuleRecord" method="post" class="form-horizontal" onsubmit="return confirm('Наистина ли искате да изтриете този запис от системата?');">
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-2">
