...
<div id="wrapper">
    ...
    <div id="textbox">
			        ...
			        <tbody>
				    	<c:forEach var="course" items="${courses}">
							<tr>
								...
								<td><c:out value="${course.moduleName}"/></td>
								<td>
									<c:choose>
										<c:when test="${course.elective == true}">
								...
								<td>
									<c:choose>
										<c:when test="${course.courseWork == true}">
											<span class="glyphicon glyphicon-ok positive-green" aria-hidden="true"></span>
										</c:when>
										<c:otherwise>
											<span class="glyphicon glyphicon-remove negative-red" aria-hidden="true"></span>
								...
								<td>
									<c:choose>
										<c:when test="${course.courseProject == true}">
											<span class="glyphicon glyphicon-ok positive-green" aria-hidden="true"></span>
										</c:when>
										<c:otherwise>
											<span class="glyphicon glyphicon-remove negative-red" aria-hidden="true"></span>
								...
								<td>
									<form action="/app/employee/editCourse" method="get">
		...
		<form action="/app/employee/createCourse" method="get">
