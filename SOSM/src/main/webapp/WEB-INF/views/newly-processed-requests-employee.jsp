...
<div id="wrapper">
    ...
    <div id="textbox">
		<c:choose>
		    <c:when test="${studentsRequestsNewList[0] != null}">
		      	<table id="dataTable" style="background-color:white" class="table table-striped table-bordered table-hover table-condensed">
			        ...
			        <tbody>
				    	<c:forEach var="studentsRequest" items="${studentsRequestsNewList}">
							<tr>
