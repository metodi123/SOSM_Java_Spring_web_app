...
<div id="wrapper">
    ...
    <div id="textbox">
		<form action="/app/admin/createAdminRecord" method="post" class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-4 control-label">Потребителско име:</label>
			    <div class="col-sm-4">
					<label class="col-sm-4 control-label"><c:out value="${param.username}"/></label>
			    </div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
		    	<div class="col-sm-offset-4 col-sm-2">
					...
					<input type="hidden" name="username" value="${param.username}" required>
