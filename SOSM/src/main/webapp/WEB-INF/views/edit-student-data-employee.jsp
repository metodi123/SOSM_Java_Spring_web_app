...
<div id="wrapper">
    ...
    <div id="textbox">
		<form action="/app/employee/editStudentRecord" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="number" class="form-control" name="currentSemester" id="currentSemester" min="1" max="8" value="${student.currentSemester}" required>
				</div>
			</div>
			<div class="form-group">
				<label for="gpa" class="col-sm-4 control-label">Успех:</label>
				<div class="col-sm-4">
					<input type="number" class="form-control" name="gpa" id="gpa" min="2" max="6" step="0.01" value="${student.GPA}" required>
				</div>
			</div>
			<div class="form-group">
				<label for="group" class="col-sm-4 control-label">Група:</label>
				<div class="col-sm-4">
					<input type="number" class="form-control" name="group" id="group" min="1" max="999" value="${student.group}" required>
				</div>
			</div>
			<div class="form-group">
					...
					<select class="form-control" name="module" id="module" required>
						...
						<c:forEach var="module" items="${modules}">
							<option value="${module.name}"
								<c:if test="${module.name == student.module}">
									selected
								</c:if>
							>
			...
			<div class="form-group">
		    	<div class="col-sm-offset-4 col-sm-2">
		    		<input type="hidden" name="facultyNumber" value="${student.facultyNumber}" required>
		...
		<br>
		<form action="/app/employee/deleteStudentRecord" method="post" class="form-horizontal" onsubmit="return confirm('Наистина ли искате да изтриете този запис от системата?');">
			<div class="form-group">
		    	<div class="col-sm-offset-4 col-sm-2">
