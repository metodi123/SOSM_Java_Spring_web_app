...
<div id="wrapper">
    ...
    <div id="textbox">
		<form action="/app/employee/createCourseRecord" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="number" class="form-control" name="semester" id="semester" min="1" max="8" required>
				</div>
			</div>
			<div class="form-group">
